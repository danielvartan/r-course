...
Provide a solid introduction to R programming, focusing on [Tidyverse](https://tidyverse.org/) principles and ecosystem.
:::
...
An introduction to [Quarto](https://quarto.org/) and [Reproducible](https://en.wikipedia.org/wiki/Reproducibility) Workflows
