...
[**"von Neumann Architecture"**](https://en.wikipedia.org/wiki/Von_Neumann_architecture) [@vonneumann1993a]
...
![](images/brookshear-2020-figure-2-1.svg){fig-align="center" style="width: 70%; padding-top: 10px;"}
...
## What We Really Do When We Program? {.smaller}
...
A [programming paradigm](https://en.m.wikipedia.org/wiki/Programming_paradigm) is a specific approach to the programming proces [@brookshear2020[p. 325]].
...
- [Procedural](https://en.m.wikipedia.org/wiki/Procedural_programming)
- [Object-Oriented](https://en.m.wikipedia.org/wiki/Object-oriented_programming)
:::
::: {.column style="width: 50%;"}
**Declarative**

- [Funcional](https://en.m.wikipedia.org/wiki/Functional_programming)
:::
::::
