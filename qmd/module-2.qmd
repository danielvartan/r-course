...
:::
::: {.column style="width: 50%;"}
[![](images/cran-logo.png){fig-align="center" style="width: 60%; padding-top: 75px;"}](https://cran.r-project.org/)
:::
::::
...
Documentation example: The [`mctq`](https://github.com/ropensci/mctq) R package.
::::
:::: {.column style="width: 5%;"}
::::
:::: {.column style="width: 47.5%;"}
...
The Tidyverse also has a meta-package (bundle) that installs or load the most important packages from the collection.
