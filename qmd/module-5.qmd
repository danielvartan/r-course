...
:::: {.columns}
::: {.column style="width: 15%; padding-top: 15px;"}
[![](images/empty-hex-logo.svg){style="width: 120px;"}](https://www.danieldsjoberg.com/gtsummary/)
:::
::: {.column style="width: 85%; padding-top: 15px;"}
[`pwr`](https://www.danieldsjoberg.com/gtsummary/) provides basic functions for power analysis.
...
::: {style="padding-top: 15px;"}
⚖️ Homogeneity of variances (equal variances) between groups (only if using Student's t-test; [Welch's t-test](https://en.wikipedia.org/wiki/Welch%27s_t-test) and our permutation approach do not require this assumption).
:::
...
Our analysis found a statistically significant difference in means ($t$ = 13.1, $p$-value < 0.001). The observed effect size was large and exceed the Minimal Effect Size (MES) threshold ($d$ = 0.94, 95% CI [0.71, 1.16]).
