...
## (AP) The `summarytools` Package {.smaller visibility="uncounted"}
...
## (AP) Digital Objects & Version Control {.smaller visibility="uncounted"}
...
## (AP) Reproducible Environments {.smaller visibility="uncounted"}
...
## (AP) App. Prog. Interfaces (APIs) {.smaller visibility="uncounted"}
