...
We will not verify the assumptions underlying the statistical test. For simplicity, we will assume that the data satisfies all necessary assumptions.

Since we are not verifying the assumptions, **the results of the statistical test may not be valid**.
