...
For some, data science is just statistics [@broman2013] (_hype statistics_). For others, it's a new interdisciplinary field that synthesizes statistics, informatics, computing, communication, management, and sociology [@cao2017]. I let you decide.
:::
...
:::: {.columns}
::: {.column style="width: 47.5%; font-size: 1em;"}
...
:::
::: {.column style="width: 47.5%;"}
![](images/allison-horst-figure-23.png){style="width: 100%; padding-top: 0px;"}
:::
::::
...
data |> readr::write_csv(here("data", "palmerpenguins-valid.csv"))
```

```{r}
#| eval: false

data |> readr::write_rds(here("data", "palmerpenguins-valid.rds"))
```
