...
![](images/holtz-2018-from-data-to-viz-poster-adapted.png){fig-align="center" style="width: 1000px; padding-top: 50px;"}
...
![](images/holtz-connection-map.png){fig-align="center" style="width: 1000px; padding-top: 15px;}"}
