...
The [`gt`](https://gt.rstudio.com/) package is the most powerful package for creating and customizing tables in R.
...
The [`gt`](https://gt.rstudio.com/) package also has several extensions that provide additional functionality for specific use cases.
...
## The `patchwork` Package {.smaller}

:::: {.columns}
::: {.column style="width: 15%;"}
[![](images/patchwork-hex-logo.svg){style="width: 120px;"}](https://patchwork.data-imaginist.com)
:::
::: {.column style="width: 85%; padding-top: 15px;"}
[`patchwork`](https://patchwork.data-imaginist.com) provides a simple and intuitive way to combine multiple [`ggplot2`](https://ggplot2.tidyverse.org/) plots into a single layout.
...
![](images/allison-horst-figure-53.png){fig-align="center" style="width: 50%;"}
...
Like [`gt`](https://gt.rstudio.com/), the [`ggplot2`](https://ggplot2.tidyverse.org/) package has several extensions that provide additional functionality for specific use cases. You can check a list of them [here](https://exts.ggplot2.tidyverse.org/gallery/).

:::: {.columns}
::: {.column style="width: 15%; padding-top: 15px;"}
[![](images/ggwordcloud-hex-logo.png){style="width: 120px;"}](https://lepennec.github.io/ggwordcloud/)
:::
::: {.column style="width: 85%; padding-top: 15px;"}
[`ggwordcloud`](https://lepennec.github.io/ggwordcloud/) provides a way to create word clouds using `ggplot2`.
...
:::: {.columns}
::: {.column style="width: 15%; padding-top: 15px;"}
[![](images/tidyplots-hex-logo.png){style="width: 120px;"}](https://tidyplots.org)
:::
::: {.column style="width: 85%; padding-top: 15px;"}
[`tidyplots`](https://tidyplots.org) provides a user-friendly code-based interface for creating customizable and insightful plots.
```r
